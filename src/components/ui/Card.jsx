...
const GlassCard = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl glass-card transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 relative overflow-hidden",
      className
    )}
    {...props}
  />
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-heading text-lg lg:text-xl font-semibold leading-none tracking-tight",
      className
    )}
    {...props}
  />
